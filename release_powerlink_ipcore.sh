...
cp common/openmac/src/openfilter-rtl-ea.vhd              ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openhub-rtl-ea.vhd                 ${DIR_RELEASE}/common/openmac/src
...
cp common/openmac/src/openmacTimer-rtl-ea.vhd             ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/phyActGen-rtl-ea.vhd          ${DIR_RELEASE}/common/openmac/src
...
cp common/openmac/src/phyMgmt-rtl-ea.vhd           ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/convRmiiToMii-rtl-ea.vhd        ${DIR_RELEASE}/common/openmac/src
...
cp common/openmac/src/openfilter-rtl-ea.vhd              ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openhub-rtl-ea.vhd                 ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/mmSlaveConv-rtl-ea.vhd      ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openmacTimer-rtl-ea.vhd             ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openMAC_DMAmaster.vhd       ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openmacPkg-p.vhd            ${DIR_RELEASE}/common/openmac/src
cp common/openmac/src/openmacTop-rtl-ea.vhd       ${DIR_RELEASE}/common/openmac/src
