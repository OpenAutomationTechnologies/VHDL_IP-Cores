...
cp --parents common/memory/src/dpRamOpenmac-e.vhd               ${DIR_RELEASE}
...
cp --parents altera/memory/src/dpRamOpenmac-rtl-a.vhd           ${DIR_RELEASE}
...
cp --parents xilinx/memory/src/dpRamOpenmac-rtl-a.vhd           ${DIR_RELEASE}
